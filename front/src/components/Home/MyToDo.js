        ...
        { show ? (
          <div className="m02-tooltip-child">
            ...
            <div className="m02-tooltip-grid">
              ...
              <div>予定期間:</div>
              <div>{displayDate(task.planned_periodfr) + " 〜 " + displayDate(task.planned_periodto)}</div>
            </div>
          </div>        
        ) : (
          <></>
        ...
        { show ? (
          <div className="m02-tooltip-child">
            ...
            <div className="m02-tooltip-grid">
              ...
              <div>承認日</div>
              <div>{displayDate(prj.approval_date)}</div>
              <div>状態</div>
              <div>{prj.status}</div>
              <div>開発期間</div>
              <div>{displayDate(prj.development_period_fr) + " 〜 " + displayDate(prj.development_period_fr)}</div>
              <div>完了予定日</div>
              <div>{displayDate(prj.scheduled_to_be_completed)}</div>
            </div>
          </div>        
        ) : (
          <></>
