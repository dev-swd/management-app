    ...
    <>
      { empId ? (
        <div className="overlay">
          <div className="m1-reset-container">
            <div className="reset-header-area">
              <div className="sub-title">ログインユーザリセット</div>
            ...
            {/* 社員情報 */}
            <div className="emp-area">
              <div className="area-title">■社員情報</div>
            ...
            {/* SignUp */}
            <div className="devise-area">
              <div className="area-title">■新しいログイン情報</div>
