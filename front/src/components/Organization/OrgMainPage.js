...
import EmpNewPage from './Emp/EmpNewPage';
import EmpAllPage from './Emp/EmpAllPage';
import EmpNotAssignPage from './Emp/EmpNotAssignPage';
import DepNewPage from './Dep/DepNewPage';
import DepUpdatePage from './Dep/DepUpdatePage';
import DivNewPage from './Div/DivNewPage';
import DivUpdatePage from './Div/DivUpdatePage';
import EmpAssignmentPage from './Emp/EmpAssignmentPage';
import AuthorizerPage from './Emp/AuthorizerPage';

import DeviseUserIndexPage from './Emp/DeviseUserIndexPage';
...
const OrgMainPage = () => {
  ...
  const [deviseFlg, setDeviseFlg] = useState(false);
    ...
    <div className="m10-org-main-bg">
      <div className="m10-org-main-container">
        ...
        <div className="m10-main-container">
          ...
          <DeviseUserIndexPage showFlg={deviseFlg} closeDevise={closeDevise} setMessage={setMessage} />
        </div>
